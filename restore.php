...
$mArr_de = array(
			...
			"DB_DEF" => "Standardwerte für Dedicated Server oder Virtuelle Maschine",
			...
			"SELECT_LANG" => "Die Sprache auswählen",
	...
	elseif (LANG == 'de')
	{
		...
		$MESS["LOADER_MENU_LIST"] = "Paket auswählen";
		$MESS["LOADER_MENU_UNPACK"] = "Datei entpacken";
		$MESS["LOADER_TITLE_LIST"] = "Datei auswählen";
		...
		$MESS["LOADER_BACK_2LIST"] = "Zurück zur Liste der Pakete";
		$MESS["LOADER_LOG_ERRORS"] = "Fehler ist aufgetreten";
		$MESS["LOADER_NO_LOG"] = "Log-Datei nicht gefunden";
		$MESS["LOADER_KB"] = "Kb";
		$MESS["LOADER_LOAD_QUERY_SERVER"] = "Verbindung mit Server...";
		...
		$MESS["LOADER_LOAD_SERVER_ANSWER1"] = "Fehler beim Herunterladen. Sie können dieses Paket nicht herunterladen. Die Antwort vom Server war: #ANS#";
		$MESS["LOADER_LOAD_NEED_RELOAD"] = "Fehler beim Herunterladen. Der Prozess kann nicht fortgesetzt.";
		$MESS["LOADER_LOAD_NO_WRITE2FILE"] = "Die Datei #FILE# kann nicht zum Schreiben geöffnet werden";
		$MESS["LOADER_LOAD_LOAD_DISTR"] = "Das Paket #DISTR# wird heruntergeladen";
		$MESS["LOADER_LOAD_ERR_SIZE"] = "Fehler der Dateigröße";
		$MESS["LOADER_LOAD_ERR_RENAME"] = "Die Datei #FILE1# kann nicht in #FILE2# umbenannt werden";
		$MESS["LOADER_LOAD_CANT_OPEN_WRITE"] = "Die Datei #FILE# kann nicht zum Schreiben geöffnet werden";
		$MESS["LOADER_LOAD_CANT_WRITE"] = "In der Datei #FILE# kann nicht geschrieben werden. Überprüfen Sie Ihren Speicherplatz.";
		$MESS["LOADER_LOAD_CANT_REDIRECT"] = "Inkorrekte Weiterleitung an #URL#. Überprüfen Sie die Download-URL.";
		$MESS["LOADER_LOAD_CANT_OPEN_READ"] = "Die Datei #FILE# kann nicht zum Lesen geöffnet werden";
		...
		$MESS["LOADER_UNPACK_UNKNOWN"] = "Unbekannter Fehler ist aufgetreten. versuchen Sie später erneut oder wenden Sie sich an den technischen Support";
		...
		$MESS["UPDATE_SUCCESS"] = "Aktualisierung war erfolgreich. <a href='?'>Öffnen</a>.";
...
elseif ($Step == 2 && !$bSelectDumpStep)
{
	...
	if ($source == 'download' || $source == 'bitrixcloud')
	{
		...
		{
			if ($_REQUEST['bitrixcloud_backup'] && $replycode == 403 && count($arHeaders)) // Retry for bitrixcloud
			{
...
elseif($Step == 1)
{
	...
	<script>
		...
		function div_show(i)
		{
			...
			strAdditionalParams = '&source=' + arSources[i];
		}
...
class CDBRestore
{
	...
	function Connect()
	{
		...
		$f = $this->Fetch($rs);
		list($k, $version) = each($f);
		$this->ft_index = version_compare($version, '5.6', '>=');
